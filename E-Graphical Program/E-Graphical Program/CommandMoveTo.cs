...
namespace E_Graphical_Program
{
    public class CommandMoveTo : ICommand
    {
        ...
        /// </summary>
        /// <param name="commandEntryList">The command list to which this command input belongs.</param>
        /// <param name="parameters">Array of parameters that provide the cursor's destination coordinates (X and Y).</param>
